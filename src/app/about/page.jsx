export default function AboutPage() {
    return (
        <div className="max-w-6xl mx-auto p-3 space-y-4">
            ...
            <p>
                Welcome to [Your Site Name], your ultimate online destination for all things cinema! Our movie database is meticulously curated to bring you comprehensive and up-to-date information about films from all genres, eras, and regions. Powered by the IMDb API, we ensure that our data is both accurate and expansive, allowing movie enthusiasts to explore detailed profiles of their favorite movies, discover new releases, and delve into the rich history of cinema. Whether you&apos;re a casual viewer or a die-hard film buff, our site provides everything you need to deepen your love for movies.
            </p>
            <p>
